    ...
    <main
        ...
        <section id="details" class="flex flex-col gap-5 px-4 mt-[33px]">
            <div id="title" class="flex flex-col gap-[6px]">
                <div class="flex items-center gap-1">
                    <h1 class="font-semibold text-xl leading-[30px] w-fit">
                        {{ $carStore->name }}
                    </h1>
                ...
                <div class="flex items-center gap-[2px]">
                    ...
                    <p class="text-sm leading-[21px] text-[#909DBF]">
                        {{ $carStore->address }}, {{ $carStore->city->name }}
                    </p>
                </div>
            </div>
        ...
        <div id="CTA-nav"
            ...
            @if ($carStore->is_open)
                ...
                @endif
            @else
                <a href="" class="rounded-full p-[12px_20px] bg-[#EEEFF4] font-bold text-[#AAADBF]">Close</a>
            @endif
